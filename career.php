                ...
                <nav class="navbar navbar-expand-lg header_nav">
                    ...
                    <div class="collapse navbar-collapse header_main_menu" id="header_main_menu">
                        <ul class="navbar-nav ml-auto nav_menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./index.php#career">Career</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-12">
                <div class="banner_content">
                    <div class="banner_content_inner">
                        <h1 class="text-center banner_title wow fadeInUp" data-wow-delay="0.3s"> Find your
                            opportunity </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="footer_single_item wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <p><i class="fa fa-map-marker"></i> : Sama Residence, 2nd Floor, Office No-226, Al Nahda First,
                        Dubai</p>
                    <p class="d-flex align-items-center"><i class="fa fa-envelope"></i> &nbsp; : &nbsp;<a
                                href="mailto:info@alkashed.com"> info@alkashed.com</a></p>
                </div>
            </div>
        </div>
    </div>
